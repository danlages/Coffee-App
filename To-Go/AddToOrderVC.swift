...
//  To-Go
//
//  Created by Dan Lages on 05/08/2018.
//  Copyright © 2018 To-Go. All rights reserved.
//

import UIKit

class AddToOrderVC: UITableViewController {
    
    //MARK: Properties
    
    @IBAction func cancelViewButton(_ sender: UIBarButtonItem) {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        dismiss(animated: true) //Dismiss popup view controller with animation
            //Must add item to order and update info
    }
}
